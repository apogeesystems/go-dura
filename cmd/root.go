...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-dura.yaml)")
...
//	})
//	viper.SetDefault("repositories", map[string]dura.WatchConfig{})
//
